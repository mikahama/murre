...
def main():
	...
	files = ["generate/flags_dist/saved_model.pb", "generate/flags_dist/variables/variables.data-00000-of-00002", "generate/flags_dist/variables/variables.data-00001-of-00002", "variables.index"]
